// @source_type: c
// @source_origin: dchisq.c
// @includes: nmath.h, dpq.h
// @depends: df, dgamma, nmath, dpq
// @provides: dchisq
// @all_depends_count: 21
// @all_depends: dpq, refactored, Rmath, nmath, stirlerr_cycle_free, chebyshev, cospi, fmax2, gammalims, lgammacor, log1p, gamma, lgamma, pgamma_utils, stirlerr_cycle_dependent, bd0, stirlerr, dbinom, dpois, dgamma, df
// @load_order: 134
