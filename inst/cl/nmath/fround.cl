...
#ifdef FROUND_MAX_DIGITS
# undef FROUND_MAX_DIGITS
#endif
...
// openclport-disabled-include: #include <config.h> /* needed for HAVE_* */
// openclport-disabled-include: #include "nmath.h"

double fround(double x, double digits) {
#define FROUND_MAX_DIGITS (DBL_MAX_10_EXP + DBL_DIG) /* typically = 308+15 = 323
    ...
    * was (DBL_DIG - 1)  till R 0.99  */
    ...
    if (digits > FROUND_MAX_DIGITS || x == 0.)
	return x;
