...
# undef max
#endif
#ifdef R_ifDEBUG_printf
# undef R_ifDEBUG_printf
#endif
#ifdef TOMS708_Log1_Exp
# undef TOMS708_Log1_Exp
#endif
#ifdef SET_0_noswap
# undef SET_0_noswap
#endif
...
// openclport-disabled-include: #include "nmath.h" /* includes config.h, math.h */
...
/* MM added R_D_LExp; keep a local variant here without overriding dpq.h */
#define TOMS708_Log1_Exp(x)   ((x) > -M_LN2 ? log(-rexpm1(x)) : log1p(-exp(x)))
...
#define SET_0_swap   \
	...
	if (b0 < min(eps, eps * a0)) { /* L80: */
	    ...
	    *w1 = log_p ? TOMS708_Log1_Exp(*w) : 0.5 - *w + 0.5;
...
L_w1_bpser:  // was L110
    ...
    *w  = log_p ? TOMS708_Log1_Exp(*w1) : 0.5 - *w1 + 0.5;
