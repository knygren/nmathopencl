...
// @provides: RMATH_H, __STDC_WANT_IEC_60559_FUNCS_EXT__, R_VERSION_STRING, HAVE_EXPM1, HAVE_HYPOT, HAVE_LOG1P, HAVE_WORKING_LOG1P, log1p, M_E, M_LOG2E, M_LOG10E, M_LN2, M_LN10, M_PI, M_2PI, M_PI_2, M_PI_4, M_1_PI, M_2_PI, M_2_SQRTPI, M_SQRT2, M_SQRT1_2, M_SQRT_3, M_SQRT_32, M_LOG10_2, M_SQRT_PI, M_1_SQRT_2PI, M_SQRT_2dPI, M_LN_2PI, M_LN_SQRT_PI, M_LN_SQRT_2PI, M_LN_SQRT_PId2, bessel_i, bessel_j, bessel_k, bessel_y, bessel_i_ex, bessel_j_ex, bessel_k_ex, bessel_y_ex, beta, choose, dbeta, dbinom, dbinom_raw, dcauchy, dchisq, dexp, df, dgamma, dgeom, dhyper, digamma, dlnorm, dlogis, dnbeta, dnbinom, dnbinom_mu, dnchisq, dnf, dnorm4, dnt, dpois_raw, dpois, dpsifn, dsignrank, dt, dtukey, dunif, dweibull, dwilcox, fmax2, fmin2, fprec, fround, ftrunc, fsign, gammafn, imax2, imin2, lbeta, lchoose, lgammafn, lgammafn_sign, lgamma1p, pow1p, log1mexp, log1pexp, log1pmx, logspace_add, logspace_sub, logspace_sum, pbeta, pbeta_raw, pbinom, pcauchy, pchisq, pentagamma, pexp, pf, pgamma, pgeom, phyper, plnorm, plogis, pnbeta, pnbinom, pnbinom_mu, pnchisq, pnf, pnorm5, pnorm_both, pnt, ppois, psignrank, psigamma, pt, ptukey, punif, pweibull, pwilcox, qbeta, qbinom, qcauchy, qchisq, qchisq_appr, qexp, qf, qgamma, qgeom, qhyper, qlnorm, qlogis, qnbeta, qnbinom, qnbinom_mu, qnchisq, qnf, qnorm5, qnt, qpois, qsignrank, qt, qtukey, qunif, qweibull, qwilcox, rbeta, rbinom, rcauchy, rchisq, rexp, rf, rgamma, rgeom, rhyper, rlnorm, rlogis, rmultinom, rnbeta, rnbinom, rnbinom_mu, rnchisq, rnf, rnorm, rnt, rpois, rsignrank, rt, rtukey, runif, rweibull, rwilcox, sign, tetragamma, trigamma, dnorm, pnorm, qnorm, Rlog1p, R_pow, R_pow_di, norm_rand , unif_rand , R_unif_index, exp_rand , log1pmx , log1pexp , pow1p , wilcox_free , signrank_free , cospi, sinpi, tanpi, Rtanpi 
// @all_depends_count: 0
// @load_order: 6
