...
#'   returned data frame.
#'
#' @details \verb{extract_library_subset()} evaluates
#' \verb{inst/extdata/opencl_known_failures.json} against the union of
#' \code{depends_tag} annotations and launcher paths.
#'
