...
#'
#' Hastie, T. J. and Pregibon, D. (1992) *Generalized linear models.* Chapter 6 of *Statistical Models in S*
#' eds J. M. Chambers and T. J. Hastie, Wadsworth & Brooks/Cole.
#'
#' McCullagh P. and Nelder, J. A. (1989) *Generalized Linear Models.* London: Chapman and Hall.
#'
#' Nygren, K.N. and Nygren, L.M (2006) Likelihood Subgradient Densities. *Journal of the American Statistical Association*.
#'
#' Raiffa, Howard and Schlaifer, R (1961) *Applied Statistical Decision Theory.* Boston: Clinton Press, Inc.
#'
#' Venables, W. N. and Ripley, B. D. (2002) *Modern Applied Statistics with S.* New York: Springer.
#'
#' @seealso \href{https://github.com/knygren/glmbayes#readme}{README on GitHub}
#' 
