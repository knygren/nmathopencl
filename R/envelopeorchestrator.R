...
#' \insertCite{Nygren2006}{nmathopencl}; see vignettes \code{Chapter-A07},
#' \code{Chapter-A11}, and \insertCite{glmbayesChapterA08,glmbayesIndNormGammaVignette}{nmathopencl}.
#'
#' @seealso
...
#' likelihood-subgradient envelope (\insertCite{Nygren2006}{nmathopencl}) is
...
#' \code{[low, upp]}. \code{vignette("Chapter-A07", package = "nmathopencl")} derives
#' the dispersion-related bounds; \code{vignette("Chapter-A11", package = "nmathopencl")}
...
#' (\insertCite{Nygren2006}{nmathopencl}; vignette \code{Chapter-A08}), then
...
#'    the likelihood-subgradient envelope pieces (\insertCite{Nygren2006}{nmathopencl};
...
#' * \code{\link{rindepNormalGamma_reg}} â€“ full Normalâ€“Gamma workflow (R + C++)
#' * \code{\link{rlmb}}, \code{\link{rglmb}}, \code{\link{simfuncs}} â€“ higher-level sampling entry points
