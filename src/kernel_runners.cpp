...
void rmath_runtime_kernel_runner(
  ...
  opencl_dbl_scalar_kernel_runner(kernel_source, kernel_name, {x, y, z}, n_out, out_flat);
}
...
void rmath_rng_kernel_runner(
  ...
  opencl_dbl_scalar_kernel_runner(kernel_source, kernel_name, {a, b, index_upper}, n_out, out_flat);
}
...
void rmath_discrete_kernel_runner(
  ...
  opencl_dbl_scalar_kernel_runner(kernel_source, kernel_name, {size, prob, lambda, mu}, n_out, out_flat);
}
...
void rmath_noncentral_kernel_runner(
  ...
  opencl_dbl_scalar_kernel_runner(kernel_source, kernel_name, {x, df, ncp, df2, p}, n_out, out_flat);
}
...
void rmath_distribution_kernel_runner(
  ...
  opencl_dbl_scalar_kernel_runner(kernel_source, kernel_name, {a, b, c, d, e}, n_out, out_flat);
}
...
void rext_utils_kernel_runner(
  ...
  opencl_dbl_scalar_kernel_runner(kernel_source, kernel_name, {}, n_out, out_flat);
}
