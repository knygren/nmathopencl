...
The diagnostic measures prior-posterior disagreement in a multivariate direction rather than
...
This is the key conceptual difference from classical p-values.
...
"probability of direction" style summaries in applied Bayesian reporting). In that language, for a scalar
...
## Legacy draft material (kept for now)
