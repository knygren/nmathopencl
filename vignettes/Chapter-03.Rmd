...
intercept_default <- coef(sum_default)["(Intercept)", "Post.Mean"]
intercept_Prtail_default <- coef(sum_default)["(Intercept)", "Pr(Prior_tail)"]

estimate_default <- sum_default$coefficients["groupTrt", "Post.Mean"]
sd_default       <- sum_default$coefficients["groupTrt", "Post.Sd"]
pr_tail_default  <- sum_default$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_default <- sum_default$pD
DIC_default <- sum_default$DIC
...
intercept_null <- coef(sum_null)["(Intercept)", "Post.Mean"]
intercept_Prtail_null <- coef(sum_null)["(Intercept)", "Pr(Prior_tail)"]
estimate_null <- sum_null$coefficients["groupTrt", "Post.Mean"]
sd_null       <- sum_null$coefficients["groupTrt", "Post.Sd"]
pr_tail_null  <- sum_null$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_null <- sum_null$pD
DIC_null <- sum_null$DIC
...
intercept_null_midpwt <- coef(sum_null_midpwt)["(Intercept)", "Post.Mean"]
intercept_Prtail_null_midpwt <- coef(sum_null_midpwt)["(Intercept)", "Pr(Prior_tail)"]
...
pr_tail_null_midpwt  <- sum_null_midpwt$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_null_midpwt <- sum_null_midpwt$pD
DIC_null_midpwt <- sum_null_midpwt$DIC
...
intercept_null_hipwt <- coef(sum_null_hipwt)["(Intercept)", "Post.Mean"]
intercept_Prtail_null_hipwt <- coef(sum_null_hipwt)["(Intercept)", "Pr(Prior_tail)"]
...
pr_tail_null_hipwt  <- sum_null_hipwt$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_null_hipwt <- sum_null_hipwt$pD
DIC_null_hipwt <- sum_null_hipwt$DIC
...
intercept_full <- coef(sum_full)["(Intercept)", "Post.Mean"]
intercept_Prtail_full <- coef(sum_full)["(Intercept)", "Pr(Prior_tail)"]
estimate_full <- sum_full$coefficients["groupTrt", "Post.Mean"]
sd_full       <- sum_full$coefficients["groupTrt", "Post.Sd"]
pr_tail_full  <- sum_full$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_full <- sum_full$pD
...
intercept_full_midpwt <- coef(sum_full_midpwt)["(Intercept)", "Post.Mean"]
intercept_Prtail_full_midpwt <- coef(sum_full_midpwt)["(Intercept)", "Pr(Prior_tail)"]
...
pr_tail_full_midpwt  <- sum_full_midpwt$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_full_midpwt <- sum_full_midpwt$pD
...
intercept_full_hipwt <- coef(sum_full_hipwt)["(Intercept)", "Post.Mean"]
intercept_Prtail_full_hipwt <- coef(sum_full_hipwt)["(Intercept)", "Pr(Prior_tail)"]
...
pr_tail_full_hipwt  <- sum_full_hipwt$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_full_hipwt <- sum_full_hipwt$pD
DIC_full_hipwt <- sum_full_hipwt$DIC
...
intercept_midpwt <- coef(sum_midpwt)["(Intercept)", "Post.Mean"]
intercept_Prtail_midpwt <- coef(sum_midpwt)["(Intercept)", "Pr(Prior_tail)"]
estimate_midpwt <- sum_midpwt$coefficients["groupTrt", "Post.Mean"]
sd_midpwt       <- sum_midpwt$coefficients["groupTrt", "Post.Sd"]
pr_tail_midpwt  <- sum_midpwt$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_midpwt <- sum_midpwt$pD
DIC_midpwt <- sum_midpwt$DIC
...
intercept_hipwt <- coef(sum_hipwt)["(Intercept)", "Post.Mean"]
intercept_Prtail_hipwt <- coef(sum_hipwt)["(Intercept)", "Pr(Prior_tail)"]
estimate_hipwt <- sum_hipwt$coefficients["groupTrt", "Post.Mean"]
sd_hipwt       <- sum_hipwt$coefficients["groupTrt", "Post.Sd"]
pr_tail_hipwt  <- sum_hipwt$coefficients["groupTrt", "Pr(Prior_tail)"]
eff_params_hipwt <- sum_hipwt$pD
DIC_hipwt <- sum_hipwt$DIC
