...
The data we will be using here is the *menarche* data covering the *Age of Menarche* for girls in Warsaw. This data appears in [@Venables2002] and in their supporting *MASS* package. It is provided (and renamed) here so as to allow examples to run during build without loading of the *MASS* package.  
