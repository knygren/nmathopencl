...
| **Prior Setup function**| **Prior_Setup** | Chapter 03 - Tailoring Priors - Leveraging the Prior_Setup Function  |
...
| **Utilities** | add_to_libpath_linux, add_to_path, add_to_path_linux, add_to_path_windows| Chapter 00 — Introduction<br>Chapter 01 — Getting Started |
